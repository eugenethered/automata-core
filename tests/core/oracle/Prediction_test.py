...
class PredictionTestCase(unittest.TestCase):
    ...
    def test_prediction_stringifies_minor_outcome(self):
        prediction = Prediction(['OTC', 'GBP'], BigFloat('0.000001'))
        self.assertEqual("Prediction(outcome=['OTC', 'GBP'], percent=0.000001, forced=False)", prediction.__str__())
